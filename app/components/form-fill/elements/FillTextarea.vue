...
<template>
	<div>
		...
		<textarea
			...
			class="form-fill-textarea w-full bg-card border border-input rounded-md py-2 px-4 text-base text-foreground resize-y min-h-[100px] transition-colors focus:outline-none focus:border-ring focus:ring-3 focus:ring-ring/10 placeholder:text-muted-foreground/50"

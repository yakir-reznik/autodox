<template>
	<main class="">
		<div v-if="profile" class="max-w-xl space-y-6">
			<!-- Account Info Card -->
				...
				<UiCardContent class="space-y-4">
					...
					<div class="flex items-center justify-between">
						...
						<div v-else class="flex items-center gap-2">
							...
							<UiButton variant="ghost" size="icon-sm" @click="editingName = false">
					...
					<div class="flex items-center justify-between">
						<div>
							...
							<div class="text-sm text-muted-foreground">
								{{
									profile.hasPassword ? "שנה את הסיסמה שלך" : "הגדר סיסמה לחשבון"
								}}
							</div>
						</div>
	...
	<UiDialog v-model:open="showPasswordModal">
		<UiDialogContent class="sm:max-w-md" dir="rtl">
			...
			<UiDialogFooter>
				<UiButton variant="outline" @click="showPasswordModal = false"> ביטול </UiButton>
